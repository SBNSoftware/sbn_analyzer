...
#ifndef CaloEhadTools_cxx
#define CaloEhadTools_cxx

#include <TMath.h>
#include <TVector3.h>

#include "CaloEhadTools.h"
...
double CaloEhadTools::ReturnMuonMomentum() {
  return fMuonMomentum;
}

double CaloEhadTools::ReturnMuonCosTheta() {
  return fMuonCosTheta;
}

double CaloEhadTools::ReturnLeadingProtonMomentum() {
  return fLeadingProtonMomentum;
}

double CaloEhadTools::ReturnLeadingProtonCosTheta() {
  return fLeadingProtonCosTheta;
}

double CaloEhadTools::ReturnRecoilProtonMomentum() {
  return fRecoilProtonMomentum;
}

double CaloEhadTools::ReturnRecoilProtonCosTheta() {
  return fRecoilProtonCosTheta;
}

double CaloEhadTools::ReturnCosOpeningAngleProtons() {
  return fCosOpeningAngleProtons;
}

double CaloEhadTools::ReturnCosOpeningAngleMuonTotalProton() {
  return fCosOpeningAngleMuonTotalProton;
}

double CaloEhadTools::ReturnTransverseMomentum() {
  return fTransverseMomentum;
}

double CaloEhadTools::ReturnDeltaAlphaT() {
  return fDeltaAlphaT;
}

double CaloEhadTools::ReturnMissingMomentum() {
  return fMissingMomentum;
}

double CaloEhadTools::ReturnInvariantMass(){
  return fInvariantMass;
}

double CaloEhadTools::ReturnCosOpeningAngleLProtonMuon(){
  return fCosOpeningAngleLProtonMuon;
}

double CaloEhadTools::ReturnCosOpeningAngleRProtonMuon(){
  return fCosOpeningAngleRProtonMuon;
}

double CaloEhadTools::ReturnAlphaThreeD() {
  return fAlphaThreeD;
}

double CaloEhadTools::ReturnCosOpeningAngleMomentumTransferTotalProton() {
